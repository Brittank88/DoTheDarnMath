...
public abstract class ConstantCommand {
    ...
    public static @NotNull LiteralArgumentBuilder<ServerCommandSource> build() {
        ...
        @NotNull LiteralArgumentBuilder<ServerCommandSource> getCommand = CommandManager.literal("get");
        ...
        @NotNull LiteralArgumentBuilder<ServerCommandSource> addCommand = CommandManager.literal("add")
                .then(CommandManager.argument("name", StringArgumentType.string())
        ...
        @NotNull LiteralArgumentBuilder<ServerCommandSource> removeCommand = CommandManager.literal("remove")
                .then(CommandManager.argument("name", StringArgumentType.string())
